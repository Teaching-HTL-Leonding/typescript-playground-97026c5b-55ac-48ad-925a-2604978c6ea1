function setup() {
    ...
    switch (dice) {
        ...
        case 4:
            circle(width / 4, height / 4, dicePointDiameter);
            circle(width / 4, height * 3 / 4, dicePointDiameter);
            circle(width * 3 / 4, height / 4, dicePointDiameter);
            circle(3 * width / 4,  height  * 3 / 4, dicePointDiameter);
            break;
        case 5:
            circle(width / 4, height / 4, dicePointDiameter);
            circle(width / 4, height * 3 / 4, dicePointDiameter);
        ...
        default:
            ...
            circle(width / 4, height * 3 / 4, dicePointDiameter);
            circle(width * 3 / 4, height / 4, dicePointDiameter);
            circle(width * 3 / 4, height / 2, dicePointDiameter);
            circle(3 * width / 4,  height  * 3 / 4, dicePointDiameter);
            break;
