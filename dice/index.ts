function setup() {
  ...
  if (dice === 1) {
    ...
    circle(width / 4, height / 4, dicePointDiameter);
    circle(width / 4, height * 0.75, dicePointDiameter);
    circle(width * 0.75, height / 4, dicePointDiameter);
    circle(width * 0.75, height * 0.75, dicePointDiameter);
  } else if (dice === 5 ) {
    ...
    circle(width / 4, height * 0.75, dicePointDiameter);
    circle(width * 0.75, height / 4, dicePointDiameter);
    circle(width * 0.75, height / 2, dicePointDiameter);
    circle(width * 0.75, height * 0.75, dicePointDiameter);
  }
